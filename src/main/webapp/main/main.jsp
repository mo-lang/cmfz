            ...
            $.get("${pageContext.request.contextPath}/menu/queryAllMenu", "",
                function (res) {
                    $.each(res, function (idx, value) {
                        var d = "";
                        $.each(value.menu, function (index, val) {
                            d += "<a class='easyui-linkbutton' data-options=\"iconCls:'" + val.iconcls + "',plain:true\" onClick=openUrl('" + val.title + "','" + val.url + "')>" + val.title + "</a><br> "
                        });
                        $('#aa').accordion('add', {
                            title: value.title,
                            content: d,
...
<div data-options="region:'north',split:true" style="height:60px;background-color:  #5C160C">
    ...
    <div style="font-size: 16px;color: #FAF7F7;font-family: 楷体;width: 300px;float:right;padding-top:15px">
        欢迎您:${sessionScope.admin.account} &nbsp;<a href="#" class="easyui-linkbutton"
